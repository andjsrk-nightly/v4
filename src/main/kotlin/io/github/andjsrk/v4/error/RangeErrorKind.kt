...
enum class RangeErrorKind(override val message: String): ErrorKind {
    ...
    INVALID_INDEX("Invalid index in a collection with size %: %"),
    INVALID_RELATIVE_INDEX("Invalid relative index in a collection with size %: %"),
    ...
    NUMBER_MUST_BE("% must be %"), // first % is needed to present argument name sometimes
    ...
    SLICE_START_GREATER_THAN_END("start index is greater than end index"),
