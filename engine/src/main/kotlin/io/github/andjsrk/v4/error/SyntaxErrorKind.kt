...
enum class SyntaxErrorKind(override val message: String): ErrorKind {
    ...
    ILLEGAL_BREAK("Illegal break expression"),
    ILLEGAL_CONTINUE("Illegal continue expression"),
    ILLEGAL_RETURN("Illegal return expression"),
    ...
    INVALID_PRIVATE_MEMBER_REINITIALIZATION("Cannot initialize % twice on the same object"),
    ...
    JSON_PARSE_NO_LEADING_ZERO("Leading zero in number literal is not allowed in JSON"),
